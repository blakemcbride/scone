...
\textbf{list-all-x} returns every element that is an instance or
subtype of its argument. There's also a \textbf{show-all-x} that
prints the result in a readable form with some indentation:
...
\item
  ...
  primitives underneath \textbf{list-all-x}, \textbf{is-x-a-y?},
